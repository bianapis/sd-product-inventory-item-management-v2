...
/**
 * BQAssignmentInitiateOutputModelAssignmentInstanceRecord
 */
public class BQAssignmentInitiateOutputModelAssignmentInstanceRecord   {
  ...
  private String productInventoryAssignmentCosts = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of inventory and delivery related costs 
